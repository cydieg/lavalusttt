...
<body>
            ...
            <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="w-100" src="<?= base_url() ?>public/images/BACK.jpg" alt="Image">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                <h6 class="section-title text-white text-uppercase mb-3 animated slideInDown">Welcome to Goco Dental Clinic</h6>
                                <h1 class="display-3 text-white mb-4 animated slideInDown"> Your Smile, Our Priority!</h1>
                        </div>
                    </div>
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                <h6 class="section-title text-white text-uppercase mb-3 animated slideInDown"> Your Ultimate Teeth Saver</h6>
                                <h1 class="display-3 text-white mb-4 animated slideInDown"> Take the first step towards a healthier, more beautiful smile today. </h1>
                             </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container-fluid booking pb-5 wow fadeIn" data-wow-delay="0.1s">
            <div class="container">
                ...
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title text-center text-primary text-uppercase">Dental Clinic</h6>
                    <h1 class="mb-5">Get an appointment <span class="text-primary text-uppercase">Now!</span></h1>
                </div>
                <?php
            ...
            ?>
                    <form action="<?php echo site_url('add'); ?>" method="post">
                        ...
                        <div class="col-md-3">
                                ...
                                <label for="manifest" class="form-label">Appointmnet</label>
                                    <label for="age" class="text-white">Appointment</label>
                                    <input placeholder="Appointment" type="date" name="checkin" id="checkin"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                <label for="manifest" class="form-label">Age</label>
                                    <label for="age" class="text-white">Age</label>
                                    <input placeholder="Age" type="number" name="checkout" id="checkout"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                <label for="manifest" class="form-label">Concern</label>
                                    <label for="adult" class="text-white">Concern</label>
                                    <input placeholder="Concern" type="text" name="adult" id="adult"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                <label for="manifest" class="form-label">Address</label>
                                    <label for="child" class="text-white">Address</label>
                                    <input placeholder="Address" type="text" name="child" id="child"
                                        class="form-control">
                                </div>
                            ...
                            <div class="form-group">
                    <label for="manifest" class="form-label">Name </label>
                    <textarea class="form-control" id="manifest" name="manifest" rows="3" placeholder="Lastname, Firstname, Middle Initial" required></textarea>
                </div>
    </div> 
                            <div class="col-md-13">
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Welcome to <span class="text-primary text-uppercase">Goco</span></h1>
                        <p class="mb-4">           Goco Dental Clinic promotes a healthier  teetch for eacg individual and offer a highly valuable services.</p>
    ...
    <div class="border rounded p-1">
                        ...
                        <div class="row g-3">
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s"
                                    src="<?= base_url() ?>public/images/download (1).jpg">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.3s"
                                    src="<?= base_url() ?>public/images/download (2).jpg">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-50 wow zoomIn" data-wow-delay="0.5s"
                                    src="<?= base_url() ?>public/images/download.jpg">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.7s"
                                    src="<?= base_url() ?>public/images/OIP.jpg">
                            </div>
                        </div>
                    </div>
        ...
        <div class="container-xxl testimonial mt-5 py-5 bg-dark wow zoomIn" data-wow-delay="0.1s"
            ...
            <div class="container">
                <div class="owl-carousel BACK-carousel py-5">
                    <div class="manifest-item position-relative bg-white rounded overflow-hidden">
                    ...
                    <?php foreach ($data as $datas) : ?>
                        <div class="carousel-item <?php echo $first ? 'active' : ''; ?>">
                            <div class="testimonial-item position-relative bg-white rounded overflow-hidden p-4">
                                ...
                                <i class="fas fa-user fa-3x img-fluid flex-shrink-0 rounded me-3"></i>
                                    <div>
